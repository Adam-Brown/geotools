...
public class SimpleFeatureBuilderTest extends TestCase {
	...
	public void testSanity() throws Exception {
		...
		assertTrue(gf.createPoint(new Coordinate(0, 0)).equals(
				feature.getAttribute("point")));
	...
	public void testCreateFeatureWithLength() throws Exception {
		...
		try {
			feature = SimpleFeatureBuilder.build(featureType,
					new Object[] { "Longer Than 5" }, "ID");
			feature.validate();
	...
	public void testCreateFeatureWithRestriction() throws Exception {
		...
		try {
			SimpleFeature sf = SimpleFeatureBuilder.build(featureType,
					new Object[] { "NotValue" }, "ID");
			sf.validate();
