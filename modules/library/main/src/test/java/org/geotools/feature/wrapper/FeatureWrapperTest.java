...
import org.geotools.feature.MineType2;
...
public class FeatureWrapperTest {
        ...
        try {
            ...
            ExceptionChecker
                    .assertExceptionMessage(
                            ice,
                            "Unable to wrap attribute in class 'class org.geotools.feature.MineType'. Reference to mineName could not be found in the attribute.");
        }
    }
    ...
    public void wrap_invalidFeatureMissingAttribute_throwsInvalidClassException() throws Exception {
        ...
        try {
            ...
            ExceptionChecker
                    .assertExceptionMessage(
                            ice,
                            "Unable to wrap attribute in class 'class org.geotools.feature.MineNameType'. urn:org:example:mineName could not be found in the attribute.");
        }
    }
    ...
    public void wrap_invalidFeatureMissingMineNameTypeProperty_throwsInvalidClassException()
        ...
        try {
            ...
            ExceptionChecker
                    .assertExceptionMessage(
                            ice,
                            "Unable to wrap attribute in class 'org.geotools.feature.MineNamePropertyType'. 'urn:org:example:MineName' doesn't have required property 'urn:org:example:MineNameType'.");
        }
    }
    ...
    public void wrap_invalidFeatureMissingMineName_throwsInvalidClassException() throws Exception {
        // Arrange
        Collection<Property> MineNamePropertyProperties = new ArrayList<Property>();
        // MineNamePropertyProperties.add(MineName); // Deliberately not adding this.
        ...
        try {
            ...
            ExceptionChecker
                    .assertExceptionMessage(
                            ice,
                            "Unable to wrap attribute in class 'org.geotools.feature.MineNamePropertyType'. 'urn:org:example:MineNamePropertyType' doesn't have required property 'urn:org:example:MineName'.");
        }
    }
}