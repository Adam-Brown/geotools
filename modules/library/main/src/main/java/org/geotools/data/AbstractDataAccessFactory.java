...
public abstract class AbstractDataAccessFactory implements DataAccessFactory {
     ...
     * <p>
     * <p>
     * Why would you ever want to override this method? If you want to check that an expected file exists and is a directory.
     * </p>
     * Overrride:
     * 
     * <pre>
...
class ParamDescriptor extends DefaultParameterDescriptor {
    ...
    public ParamDescriptor(Param param) {
        super(DefaultParameterDescriptor.create(param.key, param.description, param.type,
                param.sample, param.required));
        this.param = param;
    }
